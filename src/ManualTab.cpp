    ...
    switch (chapter) {
        ...
        // =================================================================
            return juce::String(
                ...
                "* MIDI Multi Filter - advanced 5-tab MIDI message filtering\n"
                "* VST3 Manual Loader - load any VST3 plugin from file\n"
                "* Minimap Navigator - thumbnail overview for quick panning\n"
                "* Click-and-Drag Panning - left-click empty space to pan\n"
                "* Zoom-to-Cursor - Ctrl+wheel zooms centered on mouse\n"
        ...
        // =================================================================
            return juce::String(
                ...
                "MINIMAP NAVIGATOR\n"
                "---------------------------------------------------------------\n"
                "A thumbnail overview of your entire rack, shown in the bottom-\n"
                "left corner of the canvas. It displays all nodes as small\n"
                "colored rectangles matching their actual header colours.\n\n"
                "  Viewport box    White rectangle shows your current view\n"
                "  Click           Jump the view to that position\n"
                "  Drag            Pan the view in real time\n\n"
                "The minimap scales automatically to fit all nodes. Great\n"
                "for navigating large sessions with many modules.\n\n"
                "CANVAS NAVIGATION\n"
                "---------------------------------------------------------------\n"
                "Left-click + drag on empty canvas space starts panning.\n"
                "The cursor changes to a dragging hand while panning.\n"
                "Pan speed adjusts to zoom level for consistent feel.\n\n"
        ...
        // =================================================================
            return juce::String(
                ...
                "MIDI CC REMOTE CONTROL\n"
                "---------------------------------------------------------------\n"
                "Workspaces can be switched via MIDI CC messages for\n"
                "hands-free live performance:\n\n"
                "  Workspace 1-16:  CC 102-117 (any channel)\n"
                "  Value > 63 triggers the switch\n\n"
                "Right-click any workspace button to see its CC number.\n\n"
                "Similarly, instruments 1-32 can be selected via:\n"
                "  Instrument 1-32: CC 20-51 (any channel)\n"
                "  Value > 63 triggers select/toggle\n\n"
                "These CCs are consumed before reaching plugins, so they\n"
                "won't interfere with your instrument or effects controls.\n\n"
        ...
        // =================================================================
            return juce::String(
                ...
                "VST3 MANUAL LOADER\n"
                "---------------------------------------------------------------\n"
                "If a VST3 plugin is not found by the scanner (for example,\n"
                "installed in a non-standard location), you can load it\n"
                "manually:\n\n"
                "  Right-click empty rack space > System Tools >\n"
                "    VST3 Plugin... > browse to the .vst3 file\n\n"
                "The plugin loads immediately as a node, bypassing the\n"
                "scan process entirely. Useful for development, testing,\n"
                "or plugins with custom install paths.\n"
            );
        ...
        // =================================================================
            return juce::String(
                ...
                "MIDI MULTI FILTER\n"
                "---------------------------------------------------------------\n"
                "Advanced MIDI message filter with 5 independent tabs.\n"
                "Each tab controls a different category of MIDI data:\n\n"
                "  Tab 1: Notes          Note On / Note Off messages\n"
                "  Tab 2: CCs            Control Change messages (0-127)\n"
                "  Tab 3: Prog/Bank      Program Change and Bank Select\n"
                "  Tab 4: Pitch/AT       Pitch Bend and Aftertouch\n"
                "  Tab 5: System         Clock, SysEx, Active Sensing, etc.\n\n"
                "Each tab has its own enable/disable toggle. When a tab\n"
                "is enabled, messages in that category are BLOCKED.\n"
                "When disabled, messages pass through normally.\n\n"
                "NODE FACE BUTTONS\n"
                "  E   Open the 5-tab filter editor (callout popup)\n"
                "  P   Pass-through toggle (yellow = active, bypasses\n"
                "      all filtering and lets everything through)\n"
                "  X   Delete the MIDI Multi Filter node\n\n"
                "MIDI-ONLY I/O\n"
                "  1 MIDI input pin, 1 MIDI output pin, no audio pins.\n"
                "  Place it between MIDI sources and instruments to\n"
                "  selectively block unwanted MIDI messages.\n\n"
                "Use for: blocking pitch bend on fixed-pitch instruments,\n"
                "filtering CC noise, removing aftertouch, blocking program\n"
                "changes during live performance, cleaning up MIDI streams.\n"
            );
        ...
        // =================================================================
            return juce::String(
                ...
                "CANVAS NAVIGATION\n"
                "---------------------------------------------------------------\n"
                "Left-click + drag        Pan the canvas (hand cursor)\n"
                "  on empty space\n"
                "Ctrl + Mouse Wheel       Zoom in/out (centered on cursor)\n"
                "Shift + Mouse Wheel      Horizontal scroll\n"
                "Mouse Wheel              Vertical scroll\n"
                "Click minimap            Jump view to that position\n"
                "Drag minimap             Pan view in real time\n\n"
                "MIDI MULTI FILTER\n"
                "---------------------------------------------------------------\n"
                "E button                 Open 5-tab filter editor\n"
                "P button                 Toggle pass-through (bypass all)\n"
