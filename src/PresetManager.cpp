...
void PresetManager::loadDefaultPreset()
{
    ...
    eq1.setLowFrequency(1730.6f);
    eq1.setMidFrequency(1000.0f);
    eq1.setHighFrequency(10000.0f);
    eq1.setLowQ(3.9f);
    eq1.setMidQ(0.707f);
    eq1.setHighQ(0.707f);
    ...
    params1.ratio = 2.3f;
    params1.attackMs = 0.2f;
    params1.releaseMs = 55.0f;
    params1.makeupDb = 8.9f;
    comp1.setParams(params1);
    comp1.setBypassed(false);

    // REPLACED Saturation with Exciter
    auto& exc1 = audioEngine.getExciterProcessor(0);
    ExciterProcessor::Params exParams1;
    exParams1.frequency = 3000.0f;
    exParams1.amount = 0.0f;
    exParams1.mix = 0.0f;
    ...
    eq2.setLowFrequency(2000.0f);
    eq2.setMidFrequency(1000.0f);
    eq2.setHighFrequency(10000.0f);
    eq2.setLowQ(0.707f);
    eq2.setMidQ(0.707f);
    eq2.setHighQ(0.707f);
    ...
    exParams2.frequency = 3000.0f;
    exParams2.amount = 0.0f;
    exParams2.mix = 0.0f;
    ...
    harmParams.wetDb = -3.0f;
    harmParams.glideMs = 50.0f;
    harmParams.voices[0].enabled = true;
    harmParams.voices[0].fixedSemitones = 7.0f;
    harmParams.voices[0].gainDb = -6.0f;
    harmParams.voices[1].enabled = false;
    harmParams.voices[1].fixedSemitones = 3.0f;
    ...
    reverbParams.wetGain = 0.4f;
    reverbParams.lowCutHz = 120.0f;
    reverbParams.highCutHz = 8000.0f;
    ...
    dynEQParams.duckBandHz = 3500.0f;
    dynEQParams.q = 2.5f;
    dynEQParams.shape = 0.5f;
    dynEQParams.threshold = -30.0f;
    dynEQParams.ratio = 4.0f;
    dynEQParams.attack = 10.0f;
    dynEQParams.release = 100.0f;
    dynEQ.setParams(dynEQParams);
    dynEQ.setBypassed(true);
}
