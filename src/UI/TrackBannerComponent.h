// Updated button types to `MidiTooltipTextButton`.
...
class TrackBannerComponent : public juce::Component
{
public:
...
private:
    ...
    // CHANGED: Use MidiTooltipTextButton for consistent right-click help
