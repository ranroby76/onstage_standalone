...
void ContainerProcessor::createInnerIONodes()
{
    ...
    if (innerMidiInput)   innerMidiInput->properties.set("ioNodeName", "Container MIDI In");
    if (innerMidiOutput)  innerMidiOutput->properties.set("ioNodeName", "Container MIDI Out");
