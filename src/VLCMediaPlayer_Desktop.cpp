// #D:\Workspace\onstage_colosseum_upgrade\src\VLCMediaPlayer_Desktop.cpp
/*
  ==============================================================================

    VLCMediaPlayer_Desktop.cpp
    OnStage - VLC media player with audio ring buffer and video frame capture
...
void VLCMediaPlayer_Desktop::getNextAudioBlock(const juce::AudioSourceChannelInfo& info)
{
    ...
    if (toRead > 0) {
        ...
        // Volume smoothing — ramp to prevent clicks on volume changes
