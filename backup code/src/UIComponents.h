// D:\Workspace\Subterraneum_plugins_daw\src\UIComponents.h
...
public: 
    ...
    // FIX: Properly close window by removing from desktop
    // This destroys the peer (native window handle) which signals timerCallback to clean up
    // setVisible(false) keeps the peer alive, preventing cleanup and causing E button to disappear
