// #D:\Workspace\onstage_colosseum_upgrade\src\TrackBannerComponent.cpp
...
void TrackBannerComponent::paint(juce::Graphics& g)
{
    ...
    // Draw circular button with play triangle
    float circleX = 10.0f;
    float circleY = 10.0f;
    ...
    triangle.addTriangle(
        centerX - triangleSize / 2.0f, centerY - triangleSize / 2.0f,
        centerX - triangleSize / 2.0f, centerY + triangleSize / 2.0f,
        centerX + triangleSize / 2.0f, centerY
    );
    g.fillPath(triangle);
