...
private:
    ...
    void loadLogo()
    {
        ...
        logoFile = assetsDir.getChildFile("fanan logo.png");
        if (!logoFile.existsAsFile())
        {
            logoFile = exeDir.getChildFile("fanan logo.png");
        }
        if (!logoFile.existsAsFile())
        {
            logoFile = juce::File("D:/Workspace/onstage_colosseum_upgrade/assets/fanan logo.png");
        }
